...
def raw_to_csv(list_of_properties: List[Dict[str, Optional[Union[str,float,int]]]]) -> pd.DataFrame:
    '''
    ...
    return table_of_properties

def clean_to_csv(table: pd.DataFrame) -> None:
